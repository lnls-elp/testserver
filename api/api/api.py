...
class AddLogUdc(Resource):
    def post(self):
        try:
            ...
            parser.add_argument('rtc', type=str)
            parser.add_argument('sensor_temperatura', type=str)
            parser.add_argument('control_aliment_plano_isolado', type=str)
            parser.add_argument('uart', type=str)
            parser.add_argument('sdcard', type=str)
            parser.add_argument('ethernet_inicializacao', type=str)
            parser.add_argument('ethernet_ping', type=str)
            parser.add_argument('adc_ch_1', type=str)
            parser.add_argument('adc_ch_2', type=str)
            parser.add_argument('adc_ch_3', type=str)
            parser.add_argument('adc_ch_4', type=str)
            parser.add_argument('adc_ch_5', type=str)
            parser.add_argument('adc_ch_6', type=str)
            parser.add_argument('adc_ch_7', type=str)
            parser.add_argument('adc_ch_8', type=str)
            ...
            _uart                   = args['uart']
            _sdcard                 = args['sdcard']
            _ethernet_init          = args['ethernet_inicializacao']
            _ethernet_ping          = args['ethernet_ping']
            _adc_ch_1               = args['adc_ch_1']
            _adc_ch_2               = args['adc_ch_2']
            _adc_ch_3               = args['adc_ch_3']
            _adc_ch_4               = args['adc_ch_4']
            _adc_ch_5               = args['adc_ch_5']
            _adc_ch_6               = args['adc_ch_6']
            _adc_ch_7               = args['adc_ch_7']
            _adc_ch_8               = args['adc_ch_8']
