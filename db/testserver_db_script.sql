...
CREATE TABLE IF NOT EXISTS `testserverdb`.`Fonte` (
  `numero_serie` INT NOT NULL,
  `numero_serie_bastidor` INT NOT NULL,
  PRIMARY KEY (`numero_serie`),
  INDEX `fk_Fonte_Bastidor1_idx` (`numero_serie_bastidor` ASC),
  CONSTRAINT `fk_Fonte_Bastidor1`
...
CREATE TABLE IF NOT EXISTS `testserverdb`.`LogFonte` (
  ...
  `data` DATETIME NOT NULL,
  `resultado_teste` VARCHAR(45) NOT NULL,
  `numero_serie_fonte` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `testserverdb`.`LogHradc` (
  ...
  `data` DATETIME NOT NULL,
  `resultado_teste` VARCHAR(45) NOT NULL,
  `numero_serie_hradc` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `testserverdb`.`LogModuloPotencia` (
  ...
  `data` DATETIME NOT NULL,
  `resultado_teste` VARCHAR(45) NOT NULL,
  `numero_serie_modulo_potencia` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `testserverdb`.`LogDcct` (
  ...
  `data` DATETIME NOT NULL,
  `resultado_teste` VARCHAR(45) NOT NULL,
  `numero_serie_dcct` INT NOT NULL,
  `iload0` DOUBLE NULL,
  `iload1` DOUBLE NULL,
  `iload2` DOUBLE NULL,
  `iload3` DOUBLE NULL,
