...
-- -----------------------------------------------------
-- Table `testserverdb`.`TipoTesteFonte`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testserverdb`.`TipoTesteFonte` ;

CREATE TABLE IF NOT EXISTS `testserverdb`.`TipoTesteFonte` (
  `id` INT NOT NULL,
  `descricao` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `testserverdb`.`LogFonte` (
  ...
  CONSTRAINT `fk_LogFonte_CanalFonte1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_LogFonte_TipoTesteFonte1`
    FOREIGN KEY (`id_tipo_teste_fonte`)
    REFERENCES `testserverdb`.`TipoTesteFonte` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
ALTER TABLE LogUdc
DROP COLUMN sdcard_inserido;

ALTER TABLE LogUdc
DROP COLUMN sdcard_communication;

ALTER TABLE LogUdc
ADD COLUMN sdcard VARCHAR(45);

ALTER TABLE LogUdc
DROP COLUMN io_expander0;

ALTER TABLE LogUdc
DROP COLUMN io_expander1;

ALTER TABLE LogUdc
ADD COLUMN io_expander VARCHAR(45);

ALTER TABLE LogUdc
DROP COLUMN rtc_communication;

ALTER TABLE LogUdc
DROP COLUMN rtc_interrupt;

ALTER TABLE LogUdc
ADD COLUMN rtc VARCHAR(45);

ALTER TABLE LogUdc
DROP COLUMN sensor_temperatura_com;

ALTER TABLE LogUdc
DROP COLUMN sensor_temperatura_val;

ALTER TABLE LogUdc
ADD COLUMN sensor_temperatura VARCHAR(45);
...
ALTER TABLE LogUdc
ADD COLUMN uart VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_1 VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_2 VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_3 VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_4 VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_5 VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_6 VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_7 VARCHAR(45);

ALTER TABLE LogUdc
ADD COLUMN adc_ch_8 VARCHAR(45);
